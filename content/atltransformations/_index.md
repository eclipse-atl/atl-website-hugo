...
## ATL Transformations list
  ...
  * **[Feature Models for representing runtime variability in BIS to Business Process Model Notation](#feature-models-for-representing-runtime-variability-in-bis-to-business-process-model-notation):** [Documentation](http://www.isa.us.es/uploads/tools/fm2bpmn/doc/draft.pdf), [Source files](http://www.isa.us.es/uploads/tools/fm2bpmn/transformations/top-down/full/fm2bpmn.atl)
  ...
  * **[MOF to UML](#mof-to-uml):** [Documentation](MOF2UML/ExampleMOF2UML[v00.01].pdf), [Source files](MOF2UML/UML2MOF.zip)
  ...
  * **[Software Quality Control to Mantis Bug Tracker](#software-quality-control-to-mantis-bug-tracker):** [Documentation](SoftwareQualityControl2MantisBT/ExampleSoftwareQualityControl2MantisBugTracker[v00.01].pdf), [Source files](SoftwareQualityControl2MantisBT/SoftwareQualityControl2MantisBugTracker.zip)
  ...
  * **[UML Applet, MIDlet](#uml-applet,-midlet):** [Documentation](http://ssel.vub.ac.be/ssel/research:mdd:casestudies#applet_midlet), [Source files](http://ssel.vub.ac.be/viewcvs/viewcvs.py/svn-gen/UML1CaseStudies/uml1cs-transformations/)
...
## AssertionModification
  ...
  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. The purpose of this transformation is to weakening preconditions or strengthening postconditions. This example was extracted by Eric Simon.
...
## IntroducePrimaryKey
  ...
  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. This is an essential step for implementation of a data model in relational database. This example was extracted by Julien Baudry.

## IntroducingInterface

  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. This reduces the dependencies in the model and enables separate development of A and B, and permits them to be placed in different layers or tiers of the system. This example was extracted by Julien Baudry.
...
## MakePartialRoleTotal
  ...
  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. Total associations are generally easier to implement and manage than partial associations. This example was extracted by Julien Baudry.
...
## Measure to Table
  ...
  * Documentation, Source files
    > The Measure2Table project is used to creates generic tables from a measure model. This scenario is used by the scenario Model Measurement. It is contributed by Eric Vépa (SODIUS).
...
## MergingPartialClasses
  ...
  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. The purpose of this transformation is to merge the class link by a association one-one. This example was extracted by Eric Simon.
...
## Public to Private
  ...
  * Documentation, Source files
    ...
    >
    > Source and target models conform to UML the 1.4 metamodel provided as UMLDI.xmi. A sample source model (PetriNet.xmi) and its corresponding target model (PetriNet-Privatized.xmi) are given. Both models are also given in PNG format for easy visualization: PetriNet.png and PetriNet-Privatized.png. Additional source models may be created using Poseidon (http://www.gentleware.com/).
    >
    > References:
...
## RedundantClassRemovable
  ...
  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. The purpose of this transformation is: "duplication of classes will lead to over-complex models which are difficult to modify and analyse." This example was extracted by Eric Simon.

## RemovingAssociationClass

  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. The purpose of this transformation is: "association classes cannot be represented directly in many object-oriented programming languages." This example was extracted by Eric Simon.

## RemovingManyManyAssociation

  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. The purpose of this transformation is to substitute a many-many association by an introduction of class with two many-one associations. This example was extracted by Eric Simon.
...
## ReplaceInheritanceByAssociation
  ...
  * Documentation, Source files
    > This example is extract from Catalogue of Model Transformations by K. Lano. This transformation replaces an inheritance relationship between two classes by an association between the classes. This example was extracted by Julien Baudry.
...
## UML AssociationAttributes, Java2AssociationAttributes
  ...
  * Documentation, Source files
    ...
    >   * AssociationAttributes.atl: Uses strict Java 1 API. Works on J2ME MIDP 1.0 as well.
    >   * Java2AssociationAttributes.atl: Uses the Java 2 Collections framework. Works on J2ME PP 1.0 as well.
...
## UML DataTypes, Java2DataTypes
  ...
  * Documentation, Source files
    ...
    >   * DataTypes.atl: Uses strict Java 1 API. Works on J2ME MIDP 1.0 as well.
    >   * Java2DataTypes.atl: Uses the Java 2 Collections framework. Works on J2ME PP 1.0 as well.
...
## UML AsyncMethods
  ...
  * Documentation, Source files
    > This transformation is part of the UML refinement transformations by Dennis Wagelaar.
    >
    > A simple transformation that wraps the Method body of each Operation with an "asynchronous" Stereotype inside a Thread. Uses java.lang.Thread, which is part of the Java 1.0 API. Works on J2ME MIDP 1.0 as well.
